        ...
        <div className="projects" id="Projects">
            ...
            <div className="project-list">
                <div className="project-item">
                    ...
                    <a href="https://tictactoe18.niat.tech" target="__blank" rel="noopener noreferrer"><button className="view-btn">View Project</button></a>
                </div>
                <div className="project-item">
                    <h2>2. COGNIA AI</h2>
                    ...
                    <a href="https://gemini-creators-hub.lovable.app/" target="__blank" rel="noopener noreferrer"><button className="view-btn">View Project</button></a>
                </div>
                <div className="project-item">
                    <h2>3. TIME ZONE</h2>
                    ...
                    <a href="https://timezonerz.niat.tech/" target="__blank" rel="noopener noreferrer"><button className="view-btn">View Project</button></a>
                </div>
                <div className='project-item'>
                    <h2>4. Web Page</h2>
                    ...
                    <a href="http://digitalexrz.niat.tech" target="__blank" rel=""><button className='view-btn'>View Project</button></a>
                </div>
            </div>
        </div>
    );  
